...
matches_dir = os.path.join(output_dir, "brisk_matches")
reconstruction_dir = os.path.join(output_dir, "brisk_recon")
...
pFeatures = subprocess.Popen( [os.path.join(OPENMVG_SFM_BIN, "openMVG_main_ComputeFeatures_OpenCV"),  "-i", matches_dir+"/sfm_data.json", "-o", matches_dir, "-m", "BRISK_OPENCV"] )
pFeatures.wait()
